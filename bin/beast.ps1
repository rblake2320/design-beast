...
switch ($Cmd) {
    'blender' { python (Join-Path $Repo 'scripts\blender_execute.py') @Rest; exit $LASTEXITCODE }
...
beast blender PROCEDURE --output NEW_DIR --allow-execute   isolated Blender execution + native proof
